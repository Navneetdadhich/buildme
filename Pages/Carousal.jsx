  ...
  return (
    <div className="flex flex-col h-full w-full relative z-50">
      <div className="border-b border-b-gray-400 w-full py-5 px-3 sm:px-16 h-[60px] sm:h-[80px] flex flex-row items-center justify-between  z-11">
        ...
        <h2 className="playwrite text-lg sm:text-4xl font-bold">BuildMe</h2>
      ...
      <div className="flex flex-col gap-10 mt-10">
        ...
        <div className="flex flex-col items-center justify-center text-center px-6">
          <h5 className="text-3xl sm:text-7xl font-bold">Let's Create  A<br /> Modern Resume</h5>
          <p className="mt-5 text-sm sm:text-lg sm:font-bold">Create a stunning resume with the most famous latex  themed template.<br /> BuildMe Integrates various section to enhance your resume.</p>
        </div>
